...
from .views import GiftCreateAPIView
from .views import *
from . import views
...
urlpatterns = [
    ...
    path("alluserpurchasehistory/", AllUserpurchaseHistoryView.as_view()),
     path('create-gift/', GiftCreateAPIView.as_view(), name='create-gift'),
     path('get_all_gifts/', views.get_all_gifts, name='get_all_gifts')
