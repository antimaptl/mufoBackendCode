...
urlpatterns = [
    ...
    path('post/count/', TotalPostCount.as_view(), name='total_post_count'),  # Total Post Count
    path('post/upload/', UploadPost.as_view(), name='upload_post'),          # Upload Post
    path('post/get/', GetPosts.as_view(), name='get_posts'),                # Get Posts (from followed users)
]